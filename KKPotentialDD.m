function V=KKPotentialDD(x,Scale,LMat,SpinEx,Hdd,H0)
...
%V=VDirect + SpinEx * J
VDirect=0.25*(3*KBOPotentialsv2(x,1)+KBOPotentialsv2(x,0)); %Direct term
J=(KBOPotentialsv2(x,1)-KBOPotentialsv2(x,0));  %Exchange term
